...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VOICE OFF — Voix off professionnelles" },
      {
        name: "description",
        content:
          "VOICE OFF SCHOOL : commandez une voix off professionnelle pour vos projets publicitaires, institutionnels et promotionnels.",
      },
      { name: "author", content: "VOICE OFF SCHOOL" },
